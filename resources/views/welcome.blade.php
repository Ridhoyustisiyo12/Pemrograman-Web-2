                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            onclick="return confirm('hapus data produk tersebut')" title="Hapus Produk">
                            <i class="fa-solid fa-trash-can fa-shake"></i>
                            </button>
                            <input type="hidden" name="idx" value="5">
                            </form><div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">3MSI Modern 15</h5>
                                    <!-- Product reviews-->

                                    <!-- Product price-->
                                    <span>Rp 9000000</span>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Varsity Jacket x Evos</h5>
                                    Rp 600000
                                </div>
                            </div>
                            <!-- Product actions-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Evos x Puma</h5>
                                    <!-- Product price-->
                                    <span>Rp 750000</span>
